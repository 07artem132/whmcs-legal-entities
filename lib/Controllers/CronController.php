...
use WHMCS\Module\Addon\LegalEntities\vendor\CronExpression\CronExpression;
...
class CronController
{
    ...
    function getAllFilesTask(): ?array
    {
    ...
    function generateFullClassNameFromFileName(string $fileName): string
    {
